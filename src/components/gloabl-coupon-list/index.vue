<template>
	...
	<div class="global-coupon-list-wraper">
		...
		<div class="mb10">
			...
			<!-- 地区列表 -->
			<div class="list" v-show="isShow1"   id="contry-list" v-bind:class="{'dis-block': isCountry, 'dis-none': !isCountry}">
			...
			<!--分类列表 -->
			<div class="list" v-show="isShow2" id="classify" v-bind:class="{'dis-block': isClassify, 'dis-none': !isClassify}">
